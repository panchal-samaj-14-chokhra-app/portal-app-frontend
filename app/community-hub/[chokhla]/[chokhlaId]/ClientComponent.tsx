...
import { VillageDetails } from '@/lib/server-api/getVillageDetails'

export default function ClientComponent({ villageData, chokhlaName }: Props) {
    const totalFamilies = villageData?.reduce((acc, v) => acc + v.familyCount, 0)
    const totalMembers = villageData?.reduce((acc, v) => acc + v.personCount, 0)
            ...
            <main className="container mx-auto px-3 sm:px-4 py-6 sm:py-12">
                ...
                <div className="text-center mb-8 sm:mb-12">
                    ...
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-3 sm:mb-4">
                        Know More About {chokhlaName}
                    </h2>

                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-12 max-w-6xl mx-auto pb-10">
                    ...
                    <Card className="bg-white/80 border-orange-100 shadow-lg hover:shadow-xl transition-all duration-300">
                        <CardContent className="p-4 sm:p-6 text-center">
                            ...
                            <h3 className="font-bold text-sm sm:text-base text-gray-800 mb-2"> चोखरे में कुल गांव</h3>
                    ...
                    <Card className="bg-white/80 border-orange-100 shadow-lg hover:shadow-xl transition-all duration-300">
                        <CardContent className="p-4 sm:p-6 text-center">
                            ...
                            <h3 className="font-bold text-sm sm:text-base text-gray-800 mb-2"> चोखरे में कुल परिवार</h3>
                    ...
                    <Card className="bg-white/80 border-orange-100 shadow-lg hover:shadow-xl transition-all duration-300 sm:col-span-2 lg:col-span-1">
                        <CardContent className="p-4 sm:p-6 text-center">
                            ...
                            <h3 className="font-bold text-sm sm:text-base text-gray-800 mb-2">चोखरे में कुल परिवारो के सदस्य</h3>
                    ...
                    <Card className="">
                        <CardHeader className="text-center pb-4 sm:pb-6">
                            ...
                            <CardTitle className="text-xl sm:text-2xl md:text-3xl text-orange-700 mb-2">
                                {chokhlaName} चोखरे की डिजिटल रूप से जुड़ी जनसंख्या की जानकारी
                            </CardTitle>
                        ...
                        <CardContent className="space-y-6 sm:space-y-8">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <ChokhlaClientComponent villageData={villageData} />
                            </div>
