            ...
            <div className="text-center lg:text-left space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <h1 className="text-3xl lg:text-4xl font-bold text-gray-900">पंचाल समाज जनगणना</h1>
                  <p className="text-lg text-orange-600 font-medium">Panchal Samaj Census System 2025</p>
