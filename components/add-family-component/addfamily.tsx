            ...
            <DialogContent className="w-[95vw] max-w-6xl max-h-[95vh] overflow-hidden p-0 bg-gradient-to-br from-orange-50/30 via-white to-blue-50/30">
                ...
                <div className="max-h-[80vh] overflow-y-auto px-8 py-6 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        {gpsStatus && (
                            <Alert
                                className={`border-2 shadow-lg ${gpsStatus === "success"
                            ...
                            >
                                <MapPin
                                    className={`h-5 w-5 ${gpsStatus === "success"
                                        ? "text-emerald-600"
                                        : gpsStatus === "error"
                                            ? "text-red-600"
                                            : "text-blue-600"
                                ...
                                />
                                <AlertDescription
                                    className={`font-medium ${gpsStatus === "success"
                                        ? "text-emerald-800"
                                        : gpsStatus === "error"
                                            ? "text-red-800"
                                            : "text-blue-800"
                        ...
                        {submitStatus && (
                            <Alert
                                className={`border-2 shadow-lg ${submitStatus === "success"
                                    ? "border-emerald-200 bg-gradient-to-r from-emerald-50 to-emerald-100/50"
                                    : "border-red-200 bg-gradient-to-r from-red-50 to-red-100/50"
                                    }`}
                            >
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            ...
                                            className={`h-12 text-base border-2 transition-all duration-200 ${errors.mukhiyaName
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            ...
                                            onChange={handleChange}
                                            className={`h-12 text-base border-2 transition-all duration-200 ${errors.currentFamilyVillage
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            ...
                                            onChange={handleChange}
                                            className={`h-12 text-base border-2 transition-all duration-200 ${errors.currentFamilyPincode
                                                ? "border-red-300 bg-red-50/50"
                                                : "border-gray-200 focus:border-blue-500 hover:border-blue-300"
                                                }`}
                                    ...
                                    <div className="lg:col-span-2 space-y-3">
                                        ...
                                        <Textarea
                                            ...
                                            onChange={handleChange}
                                            className={`border-2 transition-all duration-200 ${errors.currentAddress
                                                ? "border-red-300 bg-red-50/50"
                                                : "border-gray-200 focus:border-blue-500 hover:border-blue-300"
                                                }`}
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            ...
                                            onChange={handleChange}
                                            className={`h-12 text-base border-2 transition-all duration-200 ${errors.permanentFamilyVillage
                                                ? "border-red-300 bg-red-50/50"
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            ...
                                            onChange={handleChange}
                                            className={`h-12 text-base border-2 transition-all duration-200 ${errors.permanentFamilyPincode
                                                ? "border-red-300 bg-red-50/50"
                                                : "border-gray-200 focus:border-emerald-500 hover:border-emerald-300"
                                                }`}
                                            placeholder="6 अंकों का पिनकोड"
                                    ...
                                    <div className="lg:col-span-2 space-y-3">
                                        ...
                                        <Textarea
                                            ...
                                            onChange={handleChange}
                                            className={`border-2 transition-all duration-200 ${errors.permanentAddress
                                                ? "border-red-300 bg-red-50/50"
                                                : "border-gray-200 focus:border-emerald-500 hover:border-emerald-300"
                                                }`}
                                            placeholder="पूरा पता विस्तार से लिखें..."
